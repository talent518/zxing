...
public enum DecodeHintType {
	...
	/**
	 * Data type the hint is expecting. Among the possible values the {@link Void} stands out as being used for hints that do not expect a value to be supplied (flag hints). Such hints will possibly have their value ignored, or replaced by a {@link Boolean#TRUE}. Hint suppliers should probably use {@link Boolean#TRUE} as directed by the actual hint documentation.
	 */
