...
public final class LocaleManager {
	...
	/**
	 * Google Product Search for mobile is available in fewer countries than web search. See here: http://support.google.com/merchants/bin/answer.py?hl=en-GB&answer=160619
	 */
	...
	private static final Collection<String> TRANSLATED_HELP_ASSET_LANGUAGES = Arrays.asList("de", "en", "es", "fr", "it", "ja", "ko", "nl", "pt", "ru", "zh-rCN", "zh-rTW");
