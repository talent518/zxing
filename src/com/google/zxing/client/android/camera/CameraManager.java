...
public final class CameraManager {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			int width = findDesiredDimensionInRange(screenResolution.x - 40, MIN_FRAME_WIDTH, MAX_FRAME_WIDTH);
			int height = findDesiredDimensionInRange(screenResolution.y - 40, MIN_FRAME_HEIGHT, MAX_FRAME_HEIGHT);
