...
public final class OpenCameraInterface {
	 ...
	 * 
	 * @param cameraId
	 *            camera ID of the camera to use. A negative value or {@link #NO_REQUESTED_CAMERA} means "no preference", in which case a rear-facing camera is returned if possible or else any camera
