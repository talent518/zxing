...
public final class MonochromeRectangleDetector {
	 ...
	 *            if scanning horizontally, this is the row (the fixed vertical location) where we are scanning. If scanning vertically it's the column, the fixed horizontal location
	 * @param maxWhiteRun
	 *            largest run of white pixels that can still be considered part of the barcode region
	 * @param minDim
	 *            minimum pixel location, horizontally or vertically, to consider
	 * @param maxDim
	 *            maximum pixel location, horizontally or vertically, to consider
	 * @param horizontal
