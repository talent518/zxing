 ...
 * 
 * See {@link com.google.zxing.MultiFormatReader}, which attempts to determine what barcode format is present within the image as well, and then decodes it accordingly.
 * 
 * @author Sean Owen
...
public interface Reader {
	 ...
	 *            image of barcode to decode
	 * @param hints
	 *            passed as a {@link java.util.Hashtable} from {@link com.google.zxing.DecodeHintType} to arbitrary data. The meaning of the data depends upon the hint type. The implementation may or may not do anything with these hints.
	 * @return String which the barcode encodes
	 * @throws NotFoundException
	 *             if the barcode cannot be located or decoded for any reason
	 */
